...
Vivicta OneCloud Platinum (OCP) Terraform Provider. For detailed information, see the white papers available on the portal website.

## Example Usage to create VM & StaaS Volume
